...
Public Sub RegisterMenu(hMenu As Long, nPosition As Long, hwndOwner As Long, sMessage As String, iPicture As Integer, hImageList As Long)
...
If (m_bListInitialized = False) Then
    ...
    m_omList(0).InitMenu GetMenuItemID(hMenu, nPosition), sMessage, iPicture, hImageList
...
Else
    ...
    m_omList(m_nOMCount).InitMenu GetMenuItemID(hMenu, nPosition), sMessage, iPicture, hImageList
End If
End Sub
