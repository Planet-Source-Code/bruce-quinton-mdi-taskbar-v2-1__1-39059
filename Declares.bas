...
Private Sub MeasureItem(ByRef mnu As COwnMenu, ByRef lpMeasureInfo As MEASUREITEMSTRUCT, ByVal bMain As Boolean, ByVal bHasSubMenu As Boolean)
Dim hDrawDC As Long
...
Public Sub SubClassParentWnd(ByRef obj As TaskBar, ByVal hWnd As Long)
